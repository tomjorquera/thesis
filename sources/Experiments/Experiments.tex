...
\centering
	...
	\begin{subfigure}[b]{0.45\textwidth}	
		\centering
		[[TODO: put fig of cooperative trajectories]]
		\caption{Example of cooperative trajectories on Rosebrock's valley (starting point [[TODO]])}\label{collective_traj_rosenbrock_plot}
	\end{subfigure}
	
	\begin{subfigure}{0.4\textwidth}
		\centering
    	\includegraphics[width = \textwidth]{./R_figs/generated/minimizer}	
		\caption{Convergence of Rosenbrock objective for 100 random starting points [[TODO: change axis label]]}\label{rosenbrock_res}
	\end{subfigure}
\end{figure}
...
\begin{tabular}{|*3{c|} c  || *3{c|} c |}
	...
	\hline
	Turbofan\_o1 & 16 & 38 & 50 & 67.654 & 14.971 & 0.743 & 0.313\\
	Turbofan\_o2 & 10 & 23 & 35 & 23.876 & 1.853 & 0.143 & 0.101\\
	\hline
	viennet\_o1 & 4 & 17 & 31& 8.514 & 0.300 & 0.025 & 0.021\\
	viennet\_o2 & 4 & 15 & 30 & 9.412 & 0.320 & 0.02 & 0.02\\
	viennet\_o3 & 5 & 14 & 27 & 10.622 & 0.063 & 4.40E-004 & 1.68E-004\\
	\hline
\end{tabular}

\end{table}

[[TODO => Add Rosenbrock to the table]]
