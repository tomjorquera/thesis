...
%    Michle \textsc{Dupont} & \emph{Professeur, Université de Toulouse III} & (présidente du jury)\\
%    \\
%    Anne \textsc{Durand} & \emph{Professeur, Université de Caen} & (rapporteur)\\
%    \multicolumn{3}{c}{\textsc{Invité}\vspace{0.5em}}\\
%    Marc \textsc{Duval} & \emph{MCF, Université de Toulouse III} & (co-encadrant)\\
%  \end{tabular}
%  \end{center}
%}
