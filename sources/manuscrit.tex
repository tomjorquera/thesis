...
\usepackage[backend=bibtex,style=authoryear,dashed=false]{biblatex}	% dashed: replace name by dash when multiple items with same authors
...
\printbibliography[env=nolabelbib,heading=subbibliography,title=International Conferences and Workshops with Proceedings,keyword=mine,maxnames=99,keyword=international,keyword=proceedings]
\printbibliography[env=nolabelbib,heading=subbibliography,title=International Conferences and Workshops without Proceedings,keyword=mine,maxnames=99,keyword=international,keyword=noproceedings]
\printbibliography[env=nolabelbib,heading=subbibliography,title=National Conferences and Workshops without Proceedings,keyword=mine,maxnames=99,keyword=national,keyword=noproceedings]
\printbibliography[env=nolabelbib,heading=subbibliography,title=Others,keyword=mine,maxnames=99,keyword=other]
