...
An example of hidden dependency is shown in \figurename{} \ref{NCS_hidden_dependencies}
...
The fact that each agent has only a local and limited view of the problem is a requirement for the system to be able to scale to arbitrary large problems. However this restriction 
