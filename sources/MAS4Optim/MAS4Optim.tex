...
In this part we present a novel approach by modeling the problem to solve with a multi-agent system. The system then solves the problem in a distributed way while 
