...
\begin{figure}
\centering
\subfloat[The model agent receives a request.]{\begin{minipage}{0.32\textwidth}
		\centering
		\label{optim_use:1}
		\includegraphics[height=5cm]{optim_use_1}
\end{minipage}}
\hfill
\subfloat[The model agent resolves the request using an external optimizer.]{\begin{minipage}{0.32\textwidth}
		\centering
		\label{optim_use:2}
		\includegraphics[height=5cm]{optim_use_2}
\end{minipage}}
\hfill
\subfloat[The model agent transmits the new requests to its inputs.]{\begin{minipage}{0.32\textwidth}
		\centering
		\label{optim_use:3}
