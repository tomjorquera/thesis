\chapter{Multi-Agents Systems and AMAS Theory}\label{AMAS_chapter}
...
The main theme of the SMAC team\footnote{\emph{Systèmes Multi-Agents Coopératifs} (Cooperative Multi-Agents Systems)\\\url{http://irit.fr/-Equipe-SMAC-}}, in which this thesis has been realized, in the Adaptive Multi-Agent Systems (AMAS) Theory. This theory relates to the design of agent-based complex systems with self-adaptive capabilities.
