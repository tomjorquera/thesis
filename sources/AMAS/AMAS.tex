...
\item Antinomic [[?Antagonistic?]] action: the acting entity is detrimental to the other.
...
Using this axiom, several properties has been demonstrated concerning a specific set of \emph{internal cooperative medium systems}, defined as systems in which the agents do not have any antinomic[[?]] or neutral interaction. We will not enter here into the details of these properties and demonstration
...
\subsection{Cooperative Agents and Non Cooperatives Situations}
...
\hline
$C_{decision}$      & Incompetence, Improductivity[[?]] \\
\hline
...
\subsubsection{Perception NCS}

\subsubsection{Decision NCS}

\subsubsection{Action NCS}